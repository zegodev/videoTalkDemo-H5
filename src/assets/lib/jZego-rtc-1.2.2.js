...
var audioMixUtil = /** @class */ (function () {
    ...
    audioMixUtil.prototype.playEffect = function (playTime, loop, start, end) {
        var _this = this;
        ...
        this.mixEffect(this.audioBuffer, function () {
            ...
            _this.buffSource.addEventListener('ended', _this.effectEndedHandler.bind(_this));
            start && start();
        });
    };
    audioMixUtil.prototype.pauseEffect = function () {
        this.stopMixingAudio();
        this.resumeOffset = (this.pauseTimes - this.startTimes + this.startOffset) % (this.audioBuffer.duration * 1000);
    };
    audioMixUtil.prototype.resumeEffect = function () {
        this.playEffect(this.resumeOffset, this.loop);
        this.buffSource.removeEventListener('ended', this.effectEndedHandler.bind(this));
   ...
   */
    ...
    */
    ...
    ZegoPublish.prototype.playEffect = function (audioMixConfig, audioBuffer, start, end) {
        ...
        this.audioMixing.playEffect(audioMixConfig.playTime, audioMixConfig.loop, start, end);
    };

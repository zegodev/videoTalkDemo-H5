...
var MAX_TRY_HEARTBEAT_COUNT$1 = 5;
...
ZegoSignal.prototype.sendMediaDescAck = function(seq, sessionId, result) {
    ...
    sendMessage$1(this, cmd, seq, sessionId, body);
};
...
ZegoSignal.prototype.sendHeartbeat = function() {
    ...
    if (++this.tryHeartbeatCont > MAX_TRY_HEARTBEAT_COUNT$1) {
 ...
 */
function sendMessage$1(_this, cmd, seq, sessionId, body) {
    ...
    var header = getHeader$1(_this, cmd, seq, sessionId);
    var data = {
        'header': header,
        'body': body
    };
...
function getHeader$1(_this, cmd, seq, sessionId) {
    _this.globalHeader = {
